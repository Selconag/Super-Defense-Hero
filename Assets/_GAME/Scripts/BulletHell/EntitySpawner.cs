...
public class EntitySpawner : MonoBehaviour
{
    ...
    public bool UseSpawnerLocation = true;
    //Spawn Region Values
    [SerializeField]
                ...
                else
                {
                    ...
                    else
                    {
                        if (safeZone)
                            ...
                            lastEnemy = LeanPool.Spawn(m_EnemyList[Random.Range(0, m_EnemyList.Count)], new Vector3(position.x + Random.Range(minXVal, maxXVal), position.y, position.z + Random.Range(minZVal, maxZVal)), Quaternion.identity, entityPool);
